# Smile - add methods to the TimestampQueryColumn model
#
# 1/ module GroupValue
...
module Smile
  module Models
    module TimestampQueryColumnOverride
      #**************
      # 1/ GroupValue
      module GroupValue
        def self.prepended(base)
          ...
          last_postfix = '< (SM::MO::TimestampQueryColumnOverride::GroupValue)'
    ...
    end # module TimestampQueryColumnOverride
  end # module Models
end # module Smile
